...
int main() {
    ...
    GimbalIF::init(&can1,                                       &can2,
                   ...
                   GIMBAL_YAW_MOTOR_TYPE,             GIMBAL_PITCH_MOTOR_TYPE,
                   GIMBAL_BULLET_MOTOR_TYPE,         GIMBAL_PLATE_MOTOR_TYPE,
                   GIMBAL_YAW_CAN_CHANNEL,       GIMBAL_PITCH_CAN_CHANNEL,
                   GIMBAL_BULLET_CAN_CHANNEL,   GIMBAL_PLATE_CAN_CHANNEL);
