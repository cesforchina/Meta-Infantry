...
int main() {
    ...
    GimbalIF::init(&can1, &can2, GIMBAL_YAW_FRONT_ANGLE_RAW, GIMBAL_PITCH_FRONT_ANGLE_RAW,
            GIMBAL_YAW_CAN_CHANNEL, GIMBAL_BULLET_CAN_CHANNEL, GIMBAL_PLATE_CAN_CHANNEL,
            GIMBAL_YAW_MOTOR_TYPE,GIMBAL_PITCH_MOTOR_TYPE, SHOOT_BULLET_MOTOR_TYPE,
            FW_MOTOR_TYPE, SHOOT_PLATE_MOTOR_TYPE);
    ...
    ShootSKD::start(SHOOT_BULLET_INSTALL_DIRECTION, SHOOT_PLATE_INSTALL_DIRECTION, SHOOT_FW_LEFT_INSTALL_DIRECTION,
